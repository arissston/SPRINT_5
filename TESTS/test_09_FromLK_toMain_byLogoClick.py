...
def test_successful_redirect_from_LK_to_Main_page_by_logo_click(driver_login, new_user):
    ...
    driver_login.find_element(By.XPATH, ".//div[contains(@class,'logo')]/a").click()
