...
# По заданию проекта - это делать не требовалось, но я решил для себя
#   потренироваться и создать python файл, к которому теоретически можно
#   обращаться из тестовых файлов, чтобы вызывать переменные,
...
#
#   Но в данном проекте буду просто копировать отсюда пути локаторов в тесты.
...
class ProfilePageLocators:
    ...
    # А лучше в тесте ЛК просто сделать assert по  '/account/profile' in driver.current_url)
